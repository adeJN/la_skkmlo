                  ...
                  <div class="box-body">
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        <?php echo form_dropdown('fk_id_jurusan', $jurusan, set_value('fk_id_jurusan', $prodi->fk_id_jurusan), 'class="form-control" required' ); ?>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <label for="nama_prodi" class="control-label">Nama Prodi</label>
                      <div class="form-group">
                        <input type="text" name="nama_prodi" value="<?php echo set_value('nama_prodi', $prodi->nama_prodi) ?>" class="form-control" id="nama_prodi" required />
                      </div>
                    </div>
                  </div>
