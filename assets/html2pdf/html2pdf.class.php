...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    class HTML2PDF
    {
         ...
         * @return null
         */
        public function createIndex($titre = 'Index', $sizeTitle = 20, $sizeBookmark = 15, $bookmarkTitle = true, $displayPage = true, $onPage = null, $fontName = 'times new roman')
        {
...
'.$content.'
        ...
        protected function _listeGetLi()
        {
            ...
            {
                case 'none':
                    return array('times new roman', true, ' ');
                ...
                case 'lower-alpha':
                    ...
                    return array('times new roman', false, ($up ? strtoupper($str) : $str).'.');
                ...
                case 'decimal':
                    return array('times new roman', false, $nb.'.');
